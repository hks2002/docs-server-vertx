 ...
 * @LastEditDate          : 2026-05-26 15:21:44                                                                        *
...
@Log4j2
@PostMapping("/docs-api/userFuncModify")
@Permission("ADMIN")
public class UserFuncModifyHandler implements Handler<RoutingContext> {
  @Override
  public void handle(RoutingContext context) {
    UserFuncService userFuncService = new UserFuncService(context.vertx());

    userFuncService.modifyUserFunc(context.body().asJsonObject())
        .onSuccess(n -> {
